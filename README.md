...
AIRTABLE_ITEM_COLLECTION_LINK_FIELD=Collections
AIRTABLE_LEGACY_COLLECTION_FIELD=Collection
AIRTABLE_LOCATIONS_TABLE_NAME=Locations
AIRTABLE_LOCATION_NAME_FIELD=Location Code
AIRTABLE_ITEM_LOCATION_LINK_FIELD=Locations
AIRTABLE_BATCH_SOURCE_FIELD=Source
AIRTABLE_BATCH_TARGET_COLLECTION_FIELD=Target collection
AIRTABLE_BATCH_LOCATION_LINK_FIELD=Location ID
AIRTABLE_BATCH_ITEM_COUNT_FIELD=Items count
AIRTABLE_BATCH_IMPORTED_BY_FIELD=Imported by
AIRTABLE_IMPORTED_BY_USER_ID=
AIRTABLE_IMPORTED_BY_EMAIL=
```
